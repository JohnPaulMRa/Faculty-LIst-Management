                    ...
                    <thead>
                        <tr className="bg-slate-50 text-slate-600 border-b border-slate-200 uppercase text-[11px] font-bold tracking-widest">
                            ...
                            <th className="px-3 py-3 font-bold w-[15%] text-left">
                                <div className="flex items-center gap-1 cursor-pointer hover:text-blue-600 transition-colors" onClick={() => onSort("address")}>
                            ...
                            <th className="px-3 py-3 font-bold w-[10%] text-center">
                                <div className="flex items-center justify-center gap-1 cursor-pointer hover:text-blue-600 transition-colors" onClick={() => onSort("type")}>
