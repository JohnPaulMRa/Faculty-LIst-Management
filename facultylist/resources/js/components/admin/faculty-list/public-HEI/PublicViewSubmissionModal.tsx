...
import { PublicEditSubmissionModal } from './PublicEditSubmissionModal';
...
export function PublicViewSubmissionModal({ isOpen, onClose, selectedFaculty, referenceData }: PublicViewSubmissionModalProps) {
    ...
    const handleOpenEdit = () => {
        onClose(false);   // close view first to avoid double overlay
        setIsEditOpen(true);
    };
    ...
    return (
        <>
                        ...
                        <DialogTitle className="text-2xl font-bold flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                <Button
                                    ...
                                    className="flex items-center gap-2 px-4 h-9 font-semibold rounded-lg border-[#003468] text-[#003468] hover:bg-[#003468] hover:text-white transition-colors"
                                >
            ...
            {/* Edit modal — opens on top of view modal */}
            <PublicEditSubmissionModal
                isOpen={isEditOpen}
