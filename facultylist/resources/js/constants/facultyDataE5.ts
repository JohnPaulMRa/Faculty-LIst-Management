export const fullTimePartTime = [ // Full-Time/Part-Time
...
export const highestDegree = [ // Highest Degree Attained
...
export const professionalLicense = [ // Professional License
...
export const facultyRank = [ // Faculty Rank
...
export const teachingLoad = [ // Teaching Load
...
export const annualSalary = [ // Annual Salary
