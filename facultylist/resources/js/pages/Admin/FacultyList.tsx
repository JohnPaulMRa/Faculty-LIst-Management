...
export default function FacultyList({ schools, faculty, filters, referenceData }: any) {
    return (
        <AppSidebarLayout breadcrumbs={[{ title: 'Faculty List', href: '/admin/faculty-list' }]}>
            ...
            <div className="flex flex-1 flex-col w-full text-[#1b1b18] dark:text-[#EDEDEC]">
                <AdminFacultyListModule schools={schools} faculty={faculty} filters={filters} referenceData={referenceData} />
            </div>
        </AppSidebarLayout>
    );
}
