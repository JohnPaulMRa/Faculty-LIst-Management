...
export default function FacultyList({ heis, faculty, filters, referenceData, submittedYears }: any) {
    return (
        <AppSidebarLayout breadcrumbs={[{ title: 'Faculty List', href: '/admin/faculty-list' }]}>
            ...
            <div className="flex flex-1 flex-col w-full text-[#1b1b18] dark:text-[#EDEDEC]">
                <AdminFacultyListModule schools={heis} faculty={faculty} filters={filters} referenceData={referenceData} submittedYears={submittedYears} />
            </div>
        </AppSidebarLayout>
    );
}
