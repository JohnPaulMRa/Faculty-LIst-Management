...
class E5ReferenceDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->seedTable('e5_ref_gender', $gender);
        ...
        $this->seedTable('e5_ref_highest_degree', $highestDegree);
        ...
        $this->seedTable('e5_ref_professional_license', $licenses);
        ...
        $this->seedTable('e5_ref_tenure', $tenure);
        ...
        $this->seedTable('e5_ref_faculty_rank', $ranks);
        ...
        $this->seedTable('e5_ref_teaching_load', $load);
