...
'boost.browser_logs_watcher','mcp.redirect_domains','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'two-factor.disable','two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','home','dashboard','facultyprofile','faculty.store',
'faculty.update','faculty.destroy','faculty.import','faculty.submit','admin.dashboard',
'userprofile','profile.edit','profile.update','profile.destroy',
'user-password.edit','user-password.update','appearance.edit','two-factor.show','storage.local',);
